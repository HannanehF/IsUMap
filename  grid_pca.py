...
fig_dir = "/net/st1/export/clusterhome/fahimi/Documents/Grid_cell/results"
rat_name = 'R'
mod_name = '1'
sess_name = 'OF'
day_name = 'day1'
...
for rat_name, mod_name, sess_name, day_name in [('R', '1', 'OF', 'day1')]:
    ...
    #ax.scatter(dim_red_spikes_move_scaled[:, 0], dim_red_spikes_move_scaled[:, 1], dim_red_spikes_move_scaled[:, 2], s=5)
    ...
    persistence = ripser(dim_red_spikes_move_scaled , maxdim=maxdim, coeff=coeff, do_cocycles=True, distance_matrix=False, metric='euclidean')
